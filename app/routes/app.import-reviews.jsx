...
export default function ImportReviewsPage() {
  ...
  return (
    <Page>
      <ImportBreadcrumb onReviewsClick={() => embedNavigate("/app/reviews")} />
      ...
      >
        <PageHeader
          ...
          subtitle="Migrate your reviews from any platform — Loox, Stamped, Yotpo, Judge.me, Amazon, Flipkart, and more — in under 2 minutes."
        />
        <div
          style={{
            marginTop: 8,
