    ...
    <Page>
      ...
      >
        <PageHeader
          ...
          subtitle="Translate reviews for your storefront, imports, and new submissions — with full control over when and how."
        />
        ...
        {bulkActive ? (
          <Banner tone="info">
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <span>
                Translating reviews… {bulkProgress.processed.toLocaleString()} /{" "}
