...
export const SOURCE_PRESETS = {
  loox: {
    ...
    columnAliases: {
      ...
      comment: ["body", "review_body", "review", "content", "text"],
      rating: ["rating", "star_rating", "stars", "score"],
      productHandle: ["product_handle", "handle"],
      productId: ["product_id", "shopify_product_id"],
      productSku: ["sku", "variant_sku"],
      reviewDate: ["created_at", "review_date", "date", "timestamp"],
      title: ["title", "review_title"],
      email: ["email", "reviewer_email"],
      reply: ["reply", "store_reply"],
      replyDate: ["replied_at", "reply_date"],
    },
  },
  judgeme: {
    id: "judgeme",
    ...
    autoMapped: true,
    columnAliases: {
      author: ["reviewer_name", "author", "name"],
      comment: ["body", "review_body", "review", "content"],
      rating: ["rating", "star_rating", "score"],
      productHandle: ["product_handle", "handle"],
      productId: ["product_id", "shopify_product_id"],
      productSku: ["sku"],
      reviewDate: ["review_date", "created_at", "date"],
      title: ["title", "review_title"],
  ...
  stamped: {
    ...
    autoMapped: true,
    columnAliases: {
      author: ["author", "reviewauthor", "reviewer_name", "name"],
      comment: ["body", "reviewbody", "review_body", "content"],
      rating: ["rating", "reviewrating", "star_rating"],
      productHandle: ["product_handle", "handle"],
      productId: ["product_id", "productid"],
      productSku: ["sku"],
      reviewDate: ["datecreated", "created_at", "review_date", "date"],
  ...
  yotpo: {
    ...
    autoMapped: true,
    columnAliases: {
      author: ["reviewer_display_name", "reviewer_name", "author", "name"],
      comment: ["review_content", "content", "body", "review_body"],
      rating: ["review_score", "rating", "score", "star_rating"],
      productHandle: ["product_handle", "handle"],
      productId: ["product_id", "shopify_product_id"],
      productSku: ["sku"],
      reviewDate: ["review_creation_date", "created_at", "date"],
      title: ["review_title", "title"],
      email: ["reviewer_email", "email"],
      reply: ["comment_content", "reply"],
      replyDate: ["comment_created_at", "reply_date"],
    },
  },
  okendo: {
    id: "okendo",
    ...
    columnAliases: {
      ...
      productId: ["product_id", "shopify_product_id"],
      productSku: ["sku"],
      reviewDate: ["date_created", "created_at", "review_date"],
      title: ["title", "review_title"],
      email: ["reviewer_email", "email"],
      reply: ["reply", "merchant_reply"],
      replyDate: ["reply_date"],
    },
  },
  amazon: {
    ...
    columnAliases: {
      ...
      comment: ["review_text", "review_body", "body", "content", "text"],
      rating: ["star_rating", "rating", "stars", "score"],
      productHandle: ["product_handle", "handle"],
      productId: ["product_id", "shopify_product_id", "asin"],
      productSku: ["sku"],
      reviewDate: ["review_date", "created_at", "date"],
  ...
  flipkart: {
    ...
    columnAliases: {
      ...
      rating: ["rating", "star_rating", "stars", "score"],
      productHandle: ["product_handle", "handle"],
      productId: ["product_id", "shopify_product_id", "fsn"],
      productSku: ["sku"],
      reviewDate: ["review_date", "created_at", "date"],
      title: ["review_title", "title", "headline"],
      email: ["email", "reviewer_email"],
